...
/**
 * Bolt implementation to normalize text before sentiment analysis.
 */
public class SanitizationBolt extends BaseBasicBolt {
    private static final Logger LOG = LoggerFactory.getLogger(SanitizationBolt.class);
